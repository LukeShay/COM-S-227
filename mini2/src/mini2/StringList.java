 ...
 * <em>reduce</em>, and <em>reduceToList</em>. The argument to each of
 * these methods is an interface type representing an operation to be
...
public class StringList {
	...
	/**
	 * Constructs a StringList from the given file, where each line of the
	 * file becomes one item in the StringList.
	 * 
	 * @param filename
	...
	/**
	 * Returns a new StringList obtained by applying the given
	 * Transformation to every string in this StringList. This StringList
	 * is not modified.
	 * 
	 * @param transform
	 ...
	 * 
	 * @param selector
	 *            the Selector to use for selecting the strings in the
	 *            result
	 * @return a new StringList
	 */
	 ...
	 * using the given Combiner object and the given initial value. If
	 * this StringList is empty, this method just returns the given
	 * initial value.
	 * 
	 * @param combiner
	 *            the operation to be applied to successive strings
	 * @param initialValue
	 *            the initial value that is combined with the first
	 *            element
	 * @return result
	 */
	...
	/**
	 * Returns a list of objects obtained by applying the given conversion
	 * to each string in this StringList.
	 * 
	 * @param converter
	...
	public <T> ArrayList<T> mapToList(Converter<T> converter) {
		...
		for (String d : data) {
			arr.add(converter.convert(d));
		}
		return arr;
	}

	/**
	 * Returns a single string representing the contents of this
	 * StringList based on the format of java.util.ArrayList.
	 * 
	...
	/**
	 * Writes the contents of this StringList to the given output stream,
	 * one line per item.
	 * 
	 * @param out
	 *            given output stream
